...
import redisClient from '../authentication-service/auth/config/redis.config.js';
...
export default async function validateEmail(targetEmail: string) {
  ...
  // TODO: change email markup, from, text
